...
public class RdXMLController implements Initializable {
    
    private FileChooser fileChooser ;
    
    @FXML private Pagination paging;
    @FXML private RdPdf model;
...
//            listView.getItems().add(file.getName());
    ...
    private void mergePDFmain(List<String> files) throws IOException{
        ...
        try {
            ...
            Logger.getLogger(RdXMLController.class.getName()).log(Level.SEVERE, null, ex);
        } 
    ...
    private void putOnPagination(Pagination paging, File file){
        ...
        paging.setPageFactory((Integer index) -> {
            model = new RdPdf(Paths.get(file.getAbsolutePath()));
